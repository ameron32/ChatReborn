...
public class SendText extends RelativeLayout {

	Context context;
	public SendText(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		this.context = context;
		init(); 
	}

	public SendText(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		init(); 
	}
	...
	MultiAutoCompleteTextView etMessage;
...
//		voiceMicView.setImageDrawable(createVMV());
		...
		ibSend.setVisibility(RelativeLayout.GONE);
		btn_clear.setVisibility(RelativeLayout.GONE);
		voiceMicView.setVisibility(ImageView.GONE);
		...
		etMessage.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
				...
				if (s.length() > 0) {
					...
					btn_clear.setVisibility(RelativeLayout.GONE);
					if (connected && (ibSend.getVisibility() != RelativeLayout.GONE)) 
						ibSend.setVisibility(RelativeLayout.GONE);
				}
			}
